...
namespace DataStore.Entities
{
    public class Property
    {
        ...
        public ICollection<OpenViewings> OpenViewings { get; set; }
        public ICollection<VirtualViewings> VirtualViewings { get; set; }
        ...
        public ICollection<TravelTimes> TravelTimes { get; set; }
        public ICollection<AuctionList> AuctionList { get; set; }
        public ICollection<AdditionalLogoUrls> AdditionalLogoUrls { get; set; }
